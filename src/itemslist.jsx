...
import { Search, Sliders, Heart, ShoppingCart, Clock, Gift, MessageCircle, MapPin } from "lucide-react"
        ...
        <main className="w-full max-w-7xl mx-auto px-3 py-4 sm:px-4 sm:py-6 lg:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {[...Array(8)].map((_, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden"
              >
                {/* Image Skeleton */}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-200">
      ...
      <main className="w-full max-w-7xl mx-auto px-3 py-4 sm:px-4 sm:py-6 lg:px-6">
        {/* Header Section */}
        <div
          className={`mb-8 sm:mb-12 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-4 sm:mb-6 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
        ...
        <div
          className={`mb-8 sm:mb-12 space-y-4 sm:space-y-6 transition-all duration-1000 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          {/* Search Bar */}
          <div
            className={`relative max-w-2xl mx-auto transition-all duration-1000 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
        ...
        {filteredProducts.length === 0 && !loading && (
          <div
            className={`text-center py-16 sm:py-24 transition-all duration-1000 delay-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
        ...
        {filteredProducts.length > 0 && (
          <div
            className={`text-center mb-6 transition-all duration-1000 delay-800 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            <p className="text-gray-600 dark:text-gray-400">
              ...
              {(searchQuery || categoryFilter !== "All") && " matching your filters"}
            </p>
          </div>
        )}
        ...
        {filteredProducts.length > 0 && (
          <div
            className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            {filteredProducts.map((product, index) => (
              ...
              >
                <div
                  className={`product-card bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col ${
                ...
                >
                  ...
                  <div className="p-4 sm:p-6 flex-1 flex flex-col">
                    ...
                    {/* College Badge - kept for display purposes */}
                    {product.college && (
                      <div className="flex items-center gap-2 mb-3 sm:mb-4">
                          ...
                          navigator.clipboard
                            ...
                            .then(() => {
                              ...
                              e.currentTarget.innerHTML =
                                '<svg class="w-4 h-4 sm:w-5 sm:h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>'
